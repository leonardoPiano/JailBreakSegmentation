...
def custom_evaluation(global_step, model, eval_dataloader):
    ...
    evaluator = Evaluator(all_trues, all_predictions)
...
class CustomEvalDataloaderCallback(TrainerCallback):
    def __init__(self, custom_eval_dataloader, custom_eval_function):
        """
        Callback personalizzata che usa un eval_dataloader e una funzione di valutazione personalizzata
        """
    ...
    def on_log(self, args, state, control,logs=None, **kwargs):
        """
        Sostituisce il dataloader predefinito con quello personalizzato        """
        
        # Passa il dataloader personalizzato alla funzione di valutazione
